...
extern bool disable_cdtor_cloning_p		(tree);
extern bool decloned_base_cdtor_p		(tree);
extern bool decloned_complete_cdtor_p		(tree);
extern tree get_complete_for_base		(tree);
